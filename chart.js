...
function generateChartAmplitudeX(data) {
    ...
    var chart = AmCharts.makeChart("amplitudeX", {
        "type": "serial",
        "theme": "light",
...
function generateChartFixedPointX(data) {
    ...
    var chart = AmCharts.makeChart("fixationPointX", {
        "type": "serial",
        "theme": "light",
        "mouseWheelZoomEnabled": false,
        "legend": {
...
function generateChartFixedPointY(data) {
    var chartData = [];
    var benchAmptitude = 0;
    var amptitude = 0;
    var time = 0;
 console.log("generating chart fixed point y");
    for (var i = 0; i < data.length; i++) {
        benchAmptitude = data[i][1];
        amptitude = data[i][2];
        time = data[i][0]
    ...
    var chart = AmCharts.makeChart("fixationPointY", {
        "type": "serial",
        "theme": "light",
        "mouseWheelZoomEnabled": false,
        "legend": {
