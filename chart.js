...
function generateFixedChartData(arrayFixationPointX){
var chartData = [];
		var benchAmptitude = 0;
		var amptitude = 0;
		var time = 0;

		for (var i = 0; i < arrayFixationPointX.length; i++){
			benchAmptitude =  arrayFixationPointX[i][1];
			amptitude = arrayFixationPointX[i][2];
			time = arrayFixationPointX[i][0]
...
function generateGazePoint(arrayGazePointX){
var chartData = [];
		var benchAmptitude = 0;
		var amptitude = 0;
		var time = 0;
